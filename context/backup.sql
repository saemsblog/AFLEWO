...
\restrict H5Dxje2hKR9sgrQc5OmjlU6cj8KNqbNH7rNXTlhHGhMWs1pCYRVzflRyhxr8jUf
...
COPY public.chapters (id, name, slug, country, flag, venue, contact_email, contact_phone, whatsapp_link, description, status, established, is_active, created_at, updated_at) FROM stdin;
bcb30bb6-87f1-4e2f-8ca4-cd081550ec1c	Nairobi	nairobi	Kenya	🇰🇪	Winners' Chapel International, Likoni Road	nairobi@aflewo.org	+254 722 819 867	\N	The inaugural chapter and global headquarters of the AFLEWO movement. Established in 2004.	Mother Chapter	2004	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
f391652b-b519-4e4d-aa39-7b001802445b	Mombasa	mombasa	Kenya	🇰🇪	JCC Bamburi Centre, Mombasa	mombasa@aflewo.org	+254 741 200 009	\N	Founded in 2009, AFLEWO Mombasa is the movement's coastal pillar.	Prayer Circle	2009	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
b2e2cb6a-a92d-447f-8372-3dfc3fcefe85	Nakuru	nakuru	Kenya	🇰🇪	Deliverance Church Nakuru, Westside	nakuru@aflewo.org	+254 710 130 013	\N	Birthed during the celebrated 1,000-Voice National Choir event of 2013.	Registration Open	2013	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
1c9e2321-7991-4758-85ab-0d02670b36d5	Eldoret	eldoret	Kenya	🇰🇪	Eldoret Regional Hub, Uganda Road	eldoret@aflewo.org	+254 725 314 500	\N	Established in 2014 to extend the prophetic sound into the North Rift region.	Auditions Open	2014	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
9a5dad16-ff54-4395-a02a-8c24a285821e	Nyeri	nyeri	Kenya	🇰🇪	PCEA Nyamachaki, Nyeri	nyeri@aflewo.org	+254 718 056 700	\N	AFLEWO Nyeri was established in 2015 as the voice of the Mt. Kenya region.	Mt. Kenya Region	2015	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
27eb9ecc-67f4-4136-b883-ff5b1f96c2b2	Meru	meru	Kenya	🇰🇪	AIC Cathedral Meru	meru@aflewo.org	+254 726 107 600	\N	AFLEWO Meru was established in 2016 to give the Eastern Region a permanent place.	Eastern Region	2016	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
975ff09b-79b7-4079-b709-61961d5b5bf3	Machakos	machakos	Kenya	🇰🇪	Machakos People's Park Grounds	machakos@aflewo.org	+254 733 450 011	\N	Established in 2017, AFLEWO Machakos serves the Ukambani region.	Ukambani Region	2017	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
9aa3779e-44b7-4bd1-babc-44ef1a2c1948	Kisumu	kisumu	Kenya	🇰🇪	Milimani SDA Church, Kisumu	kisumu@aflewo.org	+254 700 572 000	\N	AFLEWO Kisumu was established in 2015 as the movement's anchor in the Lake Region.	Lake Region	2015	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
b47c6a5c-72e1-4009-8a58-00f5c2d630d6	Tanzania	tanzania	Tanzania	🇹🇿	CCC Upanga Church, Dar es Salaam	tanzania@aflewo.org	+255 754 810 200	\N	AFLEWO Tanzania is the movement's first international chapter, established in 2010.	Dar es Salaam	2010	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
8d59e7fa-87f2-46aa-9202-34085f2a6d8b	Rwanda	rwanda	Rwanda	🇷🇼	Christian Life Assembly, Kigali	rwanda@aflewo.org	+250 788 314 567	\N	AFLEWO Rwanda was established in 2014, the year of the 20th commemoration of the Rwandan Genocide.	Kigali Chapter	2014	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
04059c9f-e7d1-400f-92c9-c11ffb6adf88	Kampala	kampala	Uganda	🇺🇬	Watoto Church Kampala	kampala@aflewo.org	+256 701 820 200	\N	AFLEWO Kampala was established in 2018 as the movement's Ugandan anchor.	Uganda Chapter	2018	t	2026-07-02 18:54:05.001549+00	2026-07-02 18:54:05.001549+00
\.
...
CREATE POLICY attendance_admin_manage ON public.attendance USING ((EXISTS ( SELECT 1
   FROM (public.profiles
     JOIN public.chapter_events ON ((chapter_events.id = attendance.event_id)))
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['chapter_admin'::public.user_role, 'super_admin'::public.user_role, 'volunteer'::public.user_role])) AND ((profiles.chapter_id = chapter_events.chapter_id) OR (profiles.role = 'super_admin'::public.user_role))))));
...
CREATE POLICY audit_logs_chapter_admin_read ON public.system_audit_logs FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.id = system_audit_logs.performed_by) AND (profiles.role = 'chapter_admin'::public.user_role)))));
...
CREATE POLICY audit_logs_super_admin_read ON public.system_audit_logs FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.profiles
...
CREATE POLICY auditions_chapter_admin_manage ON public.auditions USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['chapter_admin'::public.user_role, 'super_admin'::public.user_role])) AND ((profiles.chapter_id = auditions.chapter_id) OR (profiles.role = 'super_admin'::public.user_role))))));
...
CREATE POLICY chapters_super_admin_write ON public.chapters USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = 'super_admin'::public.user_role)))));
...
CREATE POLICY donations_super_admin_all ON public.donation_ledger USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = 'super_admin'::public.user_role)))));
...
CREATE POLICY events_admin_manage ON public.chapter_events USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['chapter_admin'::public.user_role, 'super_admin'::public.user_role])) AND ((profiles.chapter_id = chapter_events.chapter_id) OR (profiles.role = 'super_admin'::public.user_role))))));
...
CREATE POLICY events_member_read ON public.chapter_events FOR SELECT USING (((auth.uid() IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.chapter_id = chapter_events.chapter_id) AND (profiles.role = ANY (ARRAY['choir_member'::public.user_role, 'band_member'::public.user_role, 'chapter_admin'::public.user_role, 'super_admin'::public.user_role, 'volunteer'::public.user_role])))))));
...
CREATE POLICY profiles_chapter_admin_read ON public.profiles FOR SELECT USING ((EXISTS ( SELECT 1
   FROM public.profiles admin
  WHERE ((admin.id = auth.uid()) AND (admin.role = ANY (ARRAY['chapter_admin'::public.user_role, 'super_admin'::public.user_role])) AND ((admin.chapter_id = profiles.chapter_id) OR (admin.role = 'super_admin'::public.user_role))))));
...
CREATE POLICY registrations_admin_manage ON public.registrations USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['chapter_admin'::public.user_role, 'super_admin'::public.user_role, 'volunteer'::public.user_role]))))));
...
CREATE POLICY resources_admin_manage ON public.resources USING ((EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND (profiles.role = ANY (ARRAY['chapter_admin'::public.user_role, 'super_admin'::public.user_role]))))));
...
CREATE POLICY resources_role_access ON public.resources FOR SELECT USING (((is_active = true) AND (auth.uid() IS NOT NULL) AND (EXISTS ( SELECT 1
   FROM public.profiles
  WHERE ((profiles.id = auth.uid()) AND ((profiles.role = 'super_admin'::public.user_role) OR ((profiles.role = 'chapter_admin'::public.user_role) AND ((resources.chapter_id IS NULL) OR (profiles.chapter_id = resources.chapter_id))) OR ((profiles.role = ANY (ARRAY['choir_member'::public.user_role, 'band_member'::public.user_role])) AND (resources.allowed_role = ANY (ARRAY['choir_member'::public.user_role, 'band_member'::public.user_role, 'applicant'::public.user_role]))) OR ((profiles.role = 'applicant'::public.user_role) AND (resources.allowed_role = 'applicant'::public.user_role))))))));
...
\unrestrict H5Dxje2hKR9sgrQc5OmjlU6cj8KNqbNH7rNXTlhHGhMWs1pCYRVzflRyhxr8jUf
